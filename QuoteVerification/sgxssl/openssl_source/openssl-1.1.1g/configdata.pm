...
our %config = (
  ...
  ARFLAGS => [ "r" ],
  CC => "gcc",
  CFLAGS => [ "-Wall -O3", "-include/home/mobileosdcaps/DCAP/SGXDataCenterAttestationPrimitives/QuoteVerification/sgxssl/Linux/../openssl_source/bypass_to_sgxssl.h" ],
  CPPDEFINES => [ "_FORTIFY_SOURCE=2", "GETPID_IS_MEANINGLESS" ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3", "-include/home/mobileosdcaps/DCAP/SGXDataCenterAttestationPrimitives/QuoteVerification/sgxssl/Linux/../openssl_source/bypass_to_sgxssl.h" ],
  ...
  prefix => "/home/mobileosdcaps/DCAP/SGXDataCenterAttestationPrimitives/QuoteVerification/sgxssl/Linux/../openssl_source/OpenSSL_install_dir_tmp",
  processor => "",
