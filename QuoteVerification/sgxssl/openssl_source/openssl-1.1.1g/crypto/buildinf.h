...
#define DATE "built on: Fri Oct  9 06:57:37 2020 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','c','k',' ','-','W','a','l','l',' ','-','O','3',' ','-','i',
    'n','c','l','u','d','e','/','h','o','m','e','/','m','o','b','i',
    'l','e','o','s','d','c','a','p','s','/','D','C','A','P','/','S',
    'G','X','D','a','t','a','C','e','n','t','e','r','A','t','t','e',
    's','t','a','t','i','o','n','P','r','i','m','i','t','i','v','e',
    's','/','Q','u','o','t','e','V','e','r','i','f','i','c','a','t',
    'i','o','n','/','s','g','x','s','s','l','/','L','i','n','u','x',
    '/','.','.','/','o','p','e','n','s','s','l','_','s','o','u','r',
    'c','e','/','b','y','p','a','s','s','_','t','o','_','s','g','x',
    's','s','l','.','h',' ','-','D','O','P','E','N','S','S','L','_',
